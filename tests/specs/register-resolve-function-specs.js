(function (register) {
    ...
    function Spec (hilary, expect, id) {
        return {
            'when a factory function is registered with no dependencies or arguments,': {
                // facory: class {}
            ...
            'when factory functions are registered,': {
                // facory: class {}
            ...
            'when a factory function is registered with a different number if dependencies and args,': {
            ...
            'when a factory function is registered with dependencies that are not an array,': {
                // factory: function (arg1) {} INCORRECT NUMBER OF ARGS
                'it should return an exception': function () {
                    var scope = hilary.scope(id.createUid(8), { logging: { log: function () {}}});
                    expect(scope.register({
            ...
            'when a factory function that accepts arguments, and has an empty dependencies array, is resolved,': {
                // facory: class {}
            ...
            'when a factory function that accepts arguments, and has `false` dependencies, is resolved,': {
                // facory: class {}
                'hilary should return the constructor': function () {
                    // given
                    var scope = hilary.scope(id.createUid(8)),
